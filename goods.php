...
if(isset($_POST['sub']))
{
	if($_FILES['pics']['name'] != "")
	{
		if($_FILES['pics']['type'] == "image/jpeg")
		{
			$imgName = substr(sha1(time()*rand()),0,15);
			if(move_uploaded_file($_FILES['pics']['tmp_name'],"images/product_images/".$imgName.".jpg"))
			{
				$product = new Goods();
				...
				$product->setGoods_description($_POST['description']);	
				...
				$product->Insert();
				$msg = "Product Set Successfully.";
			}
			else
			{
				$msg = "Could Not Upload Picture For The Product Please Try Again.";
			}
		}
		else
		{
			$msg = "Your Must Be Of Type Jpg Or Jpeg...";
		}
	}
	else
	{
		$msg = "You Need To Select The Picture Of The Goods You Want To Register.";
	}
}
?>
<style type="text/css">
...
function MM_validateForm() { //v4.0
  if (document.getElementById){
    ...
    for (i=0; i<(args.length-2); i+=3) { test=args[i+2]; val=document.getElementById(args[i]);
      ...
      } } } else if (test.charAt(0) == 'R') errors = ' All The Fields Is Required.\n'; }
  ...
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#999999">
      ...
      <tr>
        ...
        <tr>
          <td align="center"><form action="goods.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table width="80%" border="0" align="center" cellpadding="3" cellspacing="4">
              <tr>
                <td colspan="2" align="center" bgcolor="#1B1B1B" class="td_border"><span style="color:#FFF; font-size:18px; font-family:'Adobe Caslon Pro Bold', 'Adobe Caslon Pro', 'Adobe Garamond Pro', 'Adobe Garamond Pro Bold';"> Details Of The House You Want To Register.</span></td>
              </tr>
              <tr>
                <td align="right" class="td_border">Name</td>
                <td class="td_border"><input name="name" type="text" id="name" size="40" /></td>
              </tr>
              <tr>
                ...
                <td class="td_border"><label for="category"></label>
				  ...
				  if(!is_null($allCategory))
				  {
					  ...
					  {
						  ?>
                          <option value="<?php echo $category->getGoods_cat_id(); ?>"><?php echo $category->getCat_name(); ?></option>
                          <?php
					  }
				  }
				  ?>
              ...
              <tr>
                ...
                <td class="td_border"><label for="supplier">
              ...
              <tr>
                ...
                <td class="td_border"><label for="quantity"></label>
                  <input name="quantity" type="text" id="quantity" size="40" /></td>
              </tr>
              <tr>
                <td align="right" class="td_border">Cost Price</td>
                <td class="td_border">
                  <input name="costPrice" type="text" id="costPrice" size="40" />
                </td>
              </tr>
              <tr>
                <td align="right" class="td_border">Selling Price</td>
                <td class="td_border"><input name="sellingPrice" type="text" id="sellingPrice" size="40" /></td>
              </tr>
              <!-- Remove Comments To Add Description<tr>
                ...
                <td class="td_border"><label for="desciption"></label>
                  <textarea name="desciption" id="desciption" cols="35" rows="5"></textarea></td>
              </tr>-->
              <tr>
              <td align="right" class="td_border">Picture</td>
                <td class="td_border"><label for="description"></label>
                  <label for="pics"></label>
                  <input type="file" name="pics" id="pics" />
                  <label for="description"></label></td></tr>
              <tr>
                <td colspan="2" align="center" class="td_border"><input name="sub" type="submit" id="sub" onclick="MM_validateForm('name','','R','description','','R','quantity','','RisNum','costPrice','','RisNum','sellingPrice','','RisNum');return document.MM_returnValue" value="Create" /></td>
              </tr>
