...
<table width="900" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#F7F7F7">
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#999999">
      ...
      <tr>
        <td height="39" bgcolor="#1B1B1B"><?php include("menu.php"); ?></a></td>
      </tr>
      <tr>
        <td></td>
      </tr>
        ...
        <td height="2"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#FFFFFF">
          <tr>
            <td align="center" valign="middle" class="td_border"><table width="100%" border="0" cellspacing="4" cellpadding="3">
              ...
              <tr>
                <td align="center" valign="top"><table width="50%" border="0" cellspacing="4" cellpadding="3">
                  <tr>
                    <td colspan="4" align="left" class="td_border">List Of All Points And Their Discount Value</td>
                  </tr>
                  <?php
              ...
              ?>
                  <tr>
                    <td colspan="4" align="center" class="td_border"><span style="color:#F00; font-size:18px; font-family:'Adobe Caslon Pro Bold', 'Adobe Caslon Pro', 'Adobe Garamond Pro', 'Adobe Garamond Pro Bold';">There Are No Points In The Database.</span></td>
                  </tr>
                  <?php
				}
				?>
