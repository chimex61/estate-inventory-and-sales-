...
/*Fileds**************************************************Fields// Codes */
         ...
         private $_points; //points Field

         private $_points_id; //points_id Field
...
/*///// ******** Start Of SetMethods************* Start Of SetMethods************* Start Of SetMethods***** */
         ...
         /* This Method Will Assign The points properties Of the Object Of This Class To The Value Supplied.*/
         public function setPoints($value)
         {
         	$this->_points = $value;
         }
         /* This Method Will Assign The points_id properties Of the Object Of This Class To The Value Supplied.*/
         public function setPoints_id($value)
         {
...
/*///// ******** Start Of GetMethods************* Start Of GetMethods************* Start Of GetMethods***** */
         ...
         /* This Method Will Return The points properties Of the Object Of This Class.*/
         public function getPoints()
         {
         	 return $this->_points;
         }
         /* This Method Will Return The points_id properties Of the Object Of This Class.*/
         public function getPoints_id()
         {
...
/* ****Constructor****  ****Constructor****  ****Constructor****  ****Constructor**** */
         ...
         public function Construct($_cust_id, $_points, $_points_id)
         {
         	 $this->_cust_id = $_cust_id; 
         	 $this->_points = $_points; 
         	 $this->_points_id = $_points_id; 
         }
...
/* ****** DataAccess ******  ****** DataAccess ******  ****** DataAccess ******  ****** DataAccess ****** */
         ...
         {
         	 $sql = "INSERT INTO  `points` (`cust_id`, `points` ) VALUES (".$this->Prepare($this->getCust_id()).", ".$this->Prepare($this->getPoints())." )";
         	 $this->runScalar($sql);/*We Use RunScalar And Not RunSelect Since We Are Inserting.*/
         	 return mysql_insert_id();  /*This Return The Id Generated For points_id*/
         }
         ...
         {
         	 $sql = "update `points` set cust_id = ".$this->Prepare($this->getCust_id()).", points = ".$this->Prepare($this->getPoints())."  where points_id = '".$this->getPoints_id()."' ";
         ...
         {
         	 $sql = "Delete From `points` where  points_id = ".$this->Prepare($this->getPoints_id());
         	 $this->runScalar($sql);/*We Use RunScalar And Not RunSelect Since We Are Deleting....*/
         }


         /*This Method Sellect All Records In points Table and Construct Array Of Objects Of This Class From It.*/
         public function SelectAll()
         {
         	 ...
         	 if(mysql_num_rows($query))
         	 {
         	 	...
         	 	{
         	 	 	$object = new Points();
         	 	 	$object->Construct($r['cust_id'], $r['points'], $r['points_id']);
         	 	 	$arrObj[$i] = $object;
         	 	 	$i += 1;
         	 	}
         	 }
         ...
         /*This Method Sellect Records In points Table and Construct Array Of Objects Of This Class From It Based On The Sql Statements Supplied. Its Usually Useful For Select With Where Clause.*/
         ...
         public function SelectSingle($points_id)
         {
         	 $sql = "Select * from `points` where points_id = ".$this->Prepare($points_id);
         ...
         public function SelectAnyHow($sql)
         {
         	 ...
         	 if(mysql_num_rows($query))
         	 {
         	 	...
         	 	while($r = mysql_fetch_array($query))
         	 	{
         	 	 	...
         	 	 	$POINTS_ID = ($r['points_id'] == "")? NULL: $r['points_id'];
         	 	 	$object->Construct($CUST_ID, $POINTS, $POINTS_ID);
         	 	 	$arrObj[$i] = $object;
         	 	 	$i += 1;
         	 	}
         	 }
...
/* =============Start Of Select By Each Columns Methods.==============*/
         ...
         {
         	 $sql = "Select * from `points` where cust_id = ".$this->Prepare($cust_id);
         	 return $this->SelectWithCondition($sql);
         }
         

         /*This Method Select A record Based On The Value Of The Field points Supplied, And Return A Single Object Of This Class.*/
         public function SelectByPoints($points)
         {
         	 $sql = "Select * from `points` where points = ".$this->Prepare($points);
         	 return $this->SelectWithCondition($sql);
         }
...
/*+++++++++++++Start Of Compearer Methods ++++++++++++++*/
         ...
         public function simplesCompare($pointsObject)
         {
         ...
         public function strictCompare($pointsObject)
         {
         	 return ($this === $pointsObject);
         }
...
/***** Start Of Clone Method********* Start Of Clone Method********* Start Of Clone Method******/
         public function cloneMe($points_Object_To_Clone)
         {
         	 return clone $points_Object_To_Clone; 
         }
