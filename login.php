...
if(isset($_POST['sub']))
{
	...
	{
		$customer = $check[0];
		if($customer->getPassword() == $_POST['password'])
		{
			$_SESSION['customer'] = serialize($customer);
			?>
            <script type="text/javascript">
            alert("Login Successful, U'll Now Be Taken To The Product' Shop.");
      ...
      <tr>
        <td height="2"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#FFFFFF">
          <tr>
            ...
            <td width="39%" valign="top"><form action="login.php" method="post"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    
    <td colspan="3" class="td_border"><span class="style15"> Login Form</span></td>
  </tr>
  <tr>
    <td class="style16">Username</td>
    <td class="style16">&nbsp;</td>
    <td class="td_border"><input name="username" type="text" style="padding:5px;" onfocus="this.value = '';" size="40" /></td>
  </tr>
  <tr>
    <td class="style16">Password</td>
    <td class="style16">&nbsp;</td>
    <td class="td_border"><input name="password" type="password" id="password" style="padding:5px;" onfocus="this.value = '';" size="40" /></td>
  </tr>
  <tr>
    <td colspan="3" class="td_border" align="center"><input name="sub" type="submit" value="Login" /></td>
      ...
      <tr>
        <td background="images/mm_bg_red.gif" bgcolor="#FFFFCC">
